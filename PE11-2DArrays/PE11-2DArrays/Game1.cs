    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            for(int i = 0; i<5; i++)
            {
                ...
                {
                    grid[i, j] = new Tile(dirt, new Rectangle(i*GraphicsDevice.Viewport.Width/columns, j * GraphicsDevice.Viewport.Height/rows, GraphicsDevice.Viewport.Width, GraphicsDevice.Viewport.Height));
                }
            }
        }
